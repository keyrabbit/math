...
export function makeParentsScreen(world: World): ScreenInstance {
  ...
  function renderReport(): void {
    ...
    const complete = recipes.filter((r) => store.mastery.progress(r).complete);
    ...
    content.replaceChildren(
      ...([
        ...
        el("p", {
          class: "dim",
          textContent: `${minutesToday} minutes today · ${store.state.streakDays}-day streak`,
        }),
        ...
        struggling.length > 0
          ? el(
              ...
              el("p", {
                class: "dim",
                textContent:
                  "These come up most often as mistakes. They will be scheduled more frequently.",
              })
            )
          : null,
